...
// v1.1.5 · 审计闭环六步（检测+分类+根因+改进+回归+上线）
...
// 同步加载 snapshot 模块（v1.1.5 从 @sofagent/daemon 迁移到 @sofagent/core，消除循环依赖）
...
async function main(): Promise<void> {
  ...
  // v1.1.5：snapshot helpers 已从 @sofagent/daemon 迁移到 @sofagent/core，循环依赖已消除
