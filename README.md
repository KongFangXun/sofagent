...
> 🔮 **v1.1.0 预告**：`@sofagent/audit` 已是独立 npm 包。v1.1.0 将做包结构纯度重构——audit 只做审计，其余 10 个领域（harness / ontology / eval / core / orchestrator / daemon / ab-test / work模板市场 / think / skillopt）拆成独立包。
