...
> 📖 **行业印证（2026-08-19 红杉闭门分享吸收）**：红杉美国合伙人 Sonya Huang 说 Neo-Lab 的本质是「**先有场景，倒逼研究**」——应用公司泡在真实业务里，被具体问题逼着长出研究能力，而不是先建实验室再找场景。FDE 进场方法论正是这个逻辑的交付形态：第一步梳理工作流（先有场景），沉淀 ontology / workflow / skills（倒逼出企业专属智能）。「管理动作先行」与「先有场景倒逼研究」是同一件事的两个说法——FDE 就是企业 Neo-Lab 的研究土壤采集者。
