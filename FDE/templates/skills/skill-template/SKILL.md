...
description: >
  当 FDE 需要对业务流节点做 AI 分类判定时用这个 Skill——
  不是"它是干什么的"，是"什么时候用"。
...
note: >
  ...
  不是 FDE Agent 自己的 Skill。FDE 自己的 Skill 主入口在 SKILL/SKILL.md。
---

# 企业专属 Skill · 识别 AI 节点（sofagent 自案例 · 模板）

> 📋 **这是模板文件**——给客户企业每个 AI 节点定制的 Skill 格式参考。
> 不是 FDE Agent 自己的 Skill（那个主入口在 `SKILL/SKILL.md`，阶段指引在 `SKILL/skills/01-05`）。
>
