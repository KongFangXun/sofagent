...
# v1.3.5 #31: 锁定已发布 tag（refs/tags/v1.4.0）——main 浮动导致装到的版本不可复现；
#   升级时改此 tag 与 README 安装段同步。
INSTALL_URL="https://raw.githubusercontent.com/KongFangXun/sofagent/refs/tags/v1.4.0/install.sh"
...
LIB_BASE_URL="https://raw.githubusercontent.com/KongFangXun/sofagent/refs/tags/v1.4.0/engine/scripts/lib"
