...
| 项 | 值 |
|----|-----|
| 当前版本 | **v1.3.2**（2026-08-11） |
| 下一版 | v1.3.3（规划中，参见 docs/ROADMAP.md） |
| 测试覆盖 | 2017 测试 / 12 包（测试统计标准：有 test script 的 workspace 包；workspace 总数 13 个均发布到 npm，见 check-test-count.sh） |
...
> **维护规则**：本文档由 AI 在每次发版时更新（版本号、文件清单、状态表）。当前版本 v1.3.2 · 孔放勋 · 2026-08-11。
