...
> - **[ROADMAP.md](./ROADMAP.md)**（73KB）：版本路线图 + 已发布版本记录。当前 v1.2.6 已开发完成，待发版。
...
| 项 | 值 |
|----|-----|
| 当前版本 | **v1.2.6**（2026-08-03） |
| 下一版本 | v1.2.7（参见 docs/ROADMAP.md） |
| 测试覆盖 | 1464 测试 / 12 包（共 1464，16 因环境限制预期失败） |
...
> **维护规则**：本文档由 AI 在每次发版时更新（版本号、文件清单、状态表）。当前版本 v1.2.6 · 孔放勋 · 2026-08-03。
