...
> v1.2.6 · 2026-08-04（UTC）· 🔗 激活链 Phase 2 前半 + 🔌 MCP 修补 + 📄 文档死链清零

产品定位详见 [设计哲学](./PHILOSOPHY.md) 和 [README](../README.md)。

## 现在在哪：v1.2.6（开发完成 · 🔗 激活链 Phase 2 前半 + 🔌 MCP 修补 + 📄 死链清零）
