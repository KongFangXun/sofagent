...
> v1.4.9 · 2026-09-17（UTC）· ✅ 已发版 · 孔放勋
> v1.5.0（✅ 开发完成 · ⏳ 待发版）——治理模块 · 可见性与本体成熟：MCP 104→105 tools · 测试 4805→4903 · acceptance 352→357。完整历史见 [CHANGELOG](../CHANGELOG.md)。

产品定位详见 [设计哲学](./PHILOSOPHY.md) 和 [README](../README.md)。

## 目录

- [现在在哪：v1.4.9（已交付 · v1.5.0 待发版）](#现在在哪v149已交付--v150-待发版)
- [迭代历程](#迭代历程)
- [未来去哪](#未来去哪)
- [版本规划](#版本规划)
- [行业印证](#行业印证)
...
| 版本 | 状态 | 核心交付 | 日志 |
|------|:--:|------|:--:|
| **v1.5.0** | ✅ 开发完成（⏳ 待发版） | **🛡️ 治理模块 · 可见性与本体成熟**：治理 KPI 面板（治理 tab 六卡 + 数据集审阅 + lineage 合规报告 + 周报）· 本体数据双时态 + 三层渐进加载 · Ontology Validation Engine · 跨层证据对账 trace_reconcile · FDE 陪跑期 · 存量清扫 + @sofagent/inject 更名 · DSH 插件事件接线 · MCP 104→105 · 测试 4805→4903 · acceptance 352→357 | [日志](./changelog/v1.5/v1.5.0.md) |
