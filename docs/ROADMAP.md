...
> v1.4.0 · 2026-08-23（UTC）· 🔍 官方 AST 规则引擎 + 🧩 meta-harness 统一编排 + 📊 worklog 工作明细 + 🔬 API 分级治理 + ⚙️ FORGE driver 切 DSH
...
| **DSH WebUI 可视化（2026-08-23 新增）** | sofagent 能力（MCP 工具视图/skill 加载链/图谱栏）在 DeepSeek Harness 自带 WebUI 中可视化——v1.4.0 先放自家 dashboard，DSH 侧待 plugin 家族成熟后评估（依赖 cordis-plugin 家族） |
