...
> 当前单元测试数：388（v1.1.4 起，`npm test` 实跑，audit 包）。历史记录：v0.99.1 为 398，v0.99.8 为 407，v1.0.0 为 408，v1.0.1 为 418，v1.0.3 为 430，v1.0.6 为 480，v1.0.7 为 493，v1.0.8 为 493，v1.0.9 为 531，v1.1.3 为 343（v1.1.1 架构重构后审计核心保留 342，v1.1.3 增至 343，v1.1.4 增至 388；全 workspace 660）。
