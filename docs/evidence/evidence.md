...
| 2026-07-02 | 小嘉（蔓嘉电商）| OpenClaw (macOS, v0.99.4) | 持续使用 2+ 周 | 2 🔄 节点日常运转 | ✅ 能 | 电商运营 2 个 🔄 节点已上线运转（周报+对账），年释放 ~440-590 小时。运行不到1个月 | — | 平台反爬限制运营数据获取；需离线安装文档 | **Case 018：电商运营 FDE 部署——首个持续使用的外部案例。详见 [Case 018](./cases/fde-manjia-2026-07-02/)。** |
