...
> 当前单元测试数：见 `tools/test-count.sh` 实跑（audit 包 / 全 workspace 汇总）。历史记录（v1.1.4 起快照）：v1.1.4 为 388、v1.1.5 为 405、v1.1.6 为 405、v1.1.7 为 413、v1.1.8 为 413（audit 包）；全 workspace v1.1.4 为 660、v1.1.5 为 726、v1.1.6 为 737、v1.1.7 为 781、v1.1.8 为 852。
