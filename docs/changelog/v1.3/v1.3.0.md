...
> - **交付 8** 审计日志按 git 仓库隔离——`data/audit/runtime/<repo-hash>/`
...
>
> 开发完成快照（2026-08-09 第三批收尾）：11 项交付 · 1712 tests across 12 packages 全绿 · acceptance 241/241 · check-version 70/70 · check-docs 全绿 · FORGE smoke 11/11 · release-gate-loop PASS（BugFix 13 项 + 工具链修复 7 项见文末）
>
> 📊 测试数：1712 / 12 包全绿（新增 decision 24 + should-allow 5 + list-rules 5 + memory-backend 10 + extractor 6 + atomic-write 4 + HITL 2 + 边契约 1 等）
