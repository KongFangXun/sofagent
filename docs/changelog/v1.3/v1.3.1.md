...
> 交付：14 项 · **1962 tests across 12 packages 全绿** · acceptance 174 场景 · check-version / check-test-count / check-docs 全绿 · 国标对齐 `--gb48000` opt-in
...
- [x] `check-docs.sh` 全绿
- [x] `acceptance-test.sh` 174 场景全绿（164 既有 + 10 新增）
