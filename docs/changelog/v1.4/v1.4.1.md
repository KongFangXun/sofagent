...
> 交付：八大块（编排/审计/隔离/指纹/签名/回收/恢复/安全）+ 依赖升级 + 附项（SKILL 体系重构 + DSH 插件降实）· **3168 tests across 12 packages 全绿**（2937→3168 +231 · train 模块 15 文件；+ DSH 插件 27 测试 + OpenClaw 插件 17 测试随 v1.4.0 口径）· 四门禁全绿（check-version / check-test-count / check-docs / check-review-system）
