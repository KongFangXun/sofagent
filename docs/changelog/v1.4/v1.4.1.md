...
### 通用
- [x] `npm test` 全绿（workspace 3168 测试，12 包；全量 3212 = 3168 + DSH 27 + OpenClaw 17）
- [x] `check-version.sh` 全绿（86/86）
- [x] `check-test-count.sh` 全绿（2981+231=3212 算术自洽）
...
- [ ] release-gate-loop verdict=？（阶段五执行）
