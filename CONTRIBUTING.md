...
欢迎参与 sofagent！首先要说明：**我不会写代码**——这个项目的文件是模型间 Loop 实验的产物（核心模型是 DeepSeek V4 Pro 和 GLM-5.2，详见 [致谢](./THANKS.md#生成伙伴)）。所以你看到的任何技术问题，请直接指出来，不必客气。
