// cordis-plugin-sofagent-commons · DSH 反向插件（v1.4.8：98 行样板收敛到 @sofagent/dsh-plugin-kit）
// seam 挂载：non-seam:tool-set    # 语义：非宿主事件接入（tool 集）——能力公地五环按需调用
...
const kit = createSofagentPlugin(
  {
    ...
    seamSemantics: '非宿主事件接入（tool 集）——能力公地五环按需调用',
    capability: '能力公地（发布/发现/调用/评价/养护）',
    bridgePkg: '@sofagent/audit',
    bridgeApi: 'loadConfig',
    description: '能力公地五环——发布/发现/调用/评价/养护',
  },
