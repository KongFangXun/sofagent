...
describe('条目 5 · 注册↔分发双射守卫（第 0 步）', () => {
  it('TOOLS 恰为 103（门禁锚——v1.4.9 95→104 + v1.5.0 章八 trace 对账 104→105 + v1.5.2 章一/章二 105→107 + 2026-09-26 浏览器四件套退役 107→103）', () => {
