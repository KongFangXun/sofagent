...
// v1.1.9 新增 · v1.0.9 替换 simulateAgentRun → runMinimalAgent
// v1.1.9 新增 runDeepAgent（方案 C），保留 runMinimalAgent fallback
// current vs candidate 并行对比评测
// v1.1.9：迁移至 @sofagent/ab-test，import 路径对齐新包结构
// ============================================================
