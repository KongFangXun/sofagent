...
// v1.5.3：fast-fail 优化——委托到 rules/runner.ts
//
 ...
 * quick 模式只跑默认 17 条而规则库注册 25 条，旧版把本跑检查数当规则总数打
 * 进横幅（「17 规则」），与明细行「25 条规则 (17 默认 + 8 扩展)」自相矛盾。
 ...
 * @returns 形如「━━━ sofagent 审计 · 17 项检查 · 25 条规则 · PASS ━━━」的签名行（均为运行时实数，非写死值）
 */
