...
// v1.3.3 新增：动态 import @langchain/langgraph，启动/关闭 Agent 实例
// v1.3.3 新增：runtime.json 状态管理（name/status/startedAt/lastActive/pid）
// v1.3.3 新增：buildConstrainedSystemPrompt() 四层约束加载链
// v1.3.3：迁移至 @sofagent/orchestrator，buildConstrainedSystemPrompt → @sofagent/harness
// ============================================================
