...
> v1.0 定义为：v0.6x + v0.7x 全部完成（v0.7.0 已落地企业合规三件套），核心治理循环稳定，具备首个正式 Release 条件。以下为发布后的持续演进方向。
...
```
v0.6x (已发布)             v0.7x (当前 v0.7.0)       v1.x                       v2.x
┌─────────────┐       ┌───────────────────┐    ┌─────────────┐          ┌──────────────────┐
