...
# 上限定义
LIMIT_A=6510  # v1.3.8 排期: A 层 6502（ROADMAP 探索方向 +评测证据树行 + v1.3.8 权限单调性守卫节，正常增长铁律上调）；v1.3.6: 6411（6400→6500）
LIMIT_B=9000  # v1.3.7 阶段四 fresh-eyes 汇总段 +40 行（8988>8950 铁律上调，阶段五真实归并）
...
LIMIT_TOTAL=15510  # v1.3.7 阶段四：A+B 15487>15460（fresh-eyes 汇总段 +40），铁律上调 15460→15510（阶段五真实归并）
