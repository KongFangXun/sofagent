...
LIMIT_B=8000  # v1.2.9: B 层 7657 行（FORGE 短任务化 24 perspective prompts + lessons 沉淀自然增长），上调 6000→8000 留余量
...
LIMIT_TOTAL=14400  # v1.2.9: 随 LIMIT_B 6000→8000 同步上调（A+B=6400+8000）
