...
# 上限定义
LIMIT_A=6100  # v1.2.3: v1.2.3 功能开发文档自然增长（A 层 6019 行），上调 6000→6100 留余量
LIMIT_B=5400  # v1.2.4: LESSONS.md 升级为结构化方法论(1035行) + regression-checklist 新增 3 维度(998行)，B 层 5350 行，上调 5000→5400 留余量
...
LIMIT_TOTAL=11500  # v1.2.4: 随 LIMIT_B 5000→5400 同步上调（A+B=6100+5400）
