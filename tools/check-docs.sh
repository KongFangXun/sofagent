...
LIMIT_B=9080  # v1.3.8 阶段四事故复盘：FORGE/lessons/driver.md +20 行（阶段四审查缺位四层根因链+打勾纪律，教训实录正当增长）；此前 2026-08-19 阶段五工具化三段上调 9023>9000→9060
...
LIMIT_TOTAL=15670  # v1.3.8 阶段四事故复盘：lessons 教训实录 +20（9060→9080 同步）；此前 v1.3.8 bugfix 文档批 15628>15590 铁律上调 15590→15650
