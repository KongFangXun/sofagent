...
LIMIT_B=8300  # v1.3.0: B 层 8131 行（FORGE 短任务化 prompts + lessons 沉淀 + release-gate shard 模板铁律 + 开发日志定稿自然增长），上调 8000→8300 留余量
...
LIMIT_TOTAL=14700  # v1.3.0: 随 LIMIT_B 8000→8300 同步上调（A+B=6400+8300）
