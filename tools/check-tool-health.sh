...
DOC_SOURCES="FORGE/playbook/regression-checklist.md FORGE/playbook/fresh-eyes-review.md docs/changelog/releasing/09-tool-health.md docs/changelog/releasing/07-final-confirm.md"
