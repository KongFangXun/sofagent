...
# ════════════════════════════════════════
echo -e "\n${BOLD}── 5. CLI 二进制验证 ──${NC}"
for bin_name in sofagent-audit sofagent-orchestrator sofagent-daemon sofagent-ontology sofagent-workflow-hub sofagent-ab-test sofagent-think sofagent-skillopt sofagent-core; do
