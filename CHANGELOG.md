...
- **v1.5.1** — 编排模块 · 事件驱动：业务事件触发 · 理解债务应对 · 设备 OTA 远程升级 · 审计输入双通道 · `sofagent demo` · 测试 4903→**5083**（+180，13 包 workspace 口径，包数统计标准见 [WIKI §六](./docs/WIKI.md#六当前状态)）· acceptance 357→**367** · 回归 87 维 · 2026-09-22 已发版 · [开发日志](./docs/changelog/v1.5/v1.5.1.md)
