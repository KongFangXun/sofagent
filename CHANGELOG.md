...
- **v1.2.2** — 数据主权审计 + 混合模型路由 + FDE Dashboard + Graph Engine + 异步 HITL + Skill 升级三策略（4 维审计追踪 + 敏感度路由 + bash 三栏 + Planner 降级链 + checkpoint 挂起 + v1.2.1 BugFix 38 项）· 2026-07-28 · [开发日志](./docs/changelog/v1.2/v1.2.2.md)
...
- **v1.1.2** — LOOP 双 Agent 串联 + Harness 可见性 · 2026-07-15 · [开发日志](./docs/changelog/v1.1/v1.1.2.md)
- **v1.1.1** — 双 Agent 串联验证 + 记忆契约代码化 + 多设备同步 · 2026-07-16 · [开发日志](./docs/changelog/v1.1/v1.1.1.md)
