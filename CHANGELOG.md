...
- **v1.2.9** — 🔧 FORGE Driver 短任务化 + ⏸️ Checkpoint/Resume + 🏠 PM2 守护 + 🔗 激活链 Phase 3 后半 + mcp-server.ts 拆分 · 2026-08-XX · [开发日志](./docs/changelog/v1.2/v1.2.9.md)
- **v1.2.8** — 记忆分层 + 定时任务 + 🔗 激活链 Phase 3 前半 + 🚪 release-gate-loop F 修复者 + 🔍 FORGE 全 loop 接入 audit · 2026-08-06 · [开发日志](./docs/changelog/v1.2/v1.2.8.md)
