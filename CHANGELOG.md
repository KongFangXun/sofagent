...
- **v1.2.0** — 物理结构大重构（/sofagent/→/engine/ + SKILL 收敛 + 发版工具链归 LOOP + install.sh 提根 + rules 独立包）· 2026-07-24 · [开发日志](./docs/changelog/v1.2.0.md)
...
- **v1.0.5** — Ontology 统一层 + Workflow Hub · 2026-07-12 · [开发日志](./docs/changelog/v1.0.5.md)
