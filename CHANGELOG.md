...
> - **v0.97**：证据版本——纪律层证伪实验 + 审计 A9/A10/A11 + 编排引擎重构 + bash→TS 第二波 + 概念精简
...
> 纪律层证伪实验（100 次对照已跑，事后分析发现方法缺陷需重新设计）+ 审计 A9/A10/A11 + 编排引擎重构 + bash→TS 第二波 + 概念精简。
> 📖 [开发日志](./docs/changelog/v0.97.md) · [实验事后分析](../../experiments/v0.97-experiment-postmortem.md)
