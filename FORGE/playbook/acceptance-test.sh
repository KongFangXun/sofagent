...
scenario 375 "v1.4.5 交付面行为锁：train deliverable 打包+HMAC verify 篡改拒绝 + compliance PII findings+provenance + retention symlink 拒绝保留源 + serve 三 tools 注册面 + 模块八 FDE 进场记忆目录（10 文件/捕获/恢复）"; S375_OK=true
