...
scenario 384 "v1.4.7 G 系列工具面——五新 tool 注册（workflow_gaps/contribution_query/onboard_prompt/data_push 四名全列）+ 返回结构行为锁（dist 直调）"
S384_OK=true
