...
# ─── v1.5.1 章十（S440）+ 章十一（S441）体例归并共壳 · v1.5.2 审查面（S442-S444）：断言整体抽入 acceptance-node-probes.js，零删减 ───
...
# ─── v1.5.2 release-gate 20260924-01 判断层 P0×2/P1×2 闭环批（S445-S447）：对齐 S343/S440/S426/S430 先例 ───
