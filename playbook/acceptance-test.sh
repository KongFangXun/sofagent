...
# ─── v1.5.3 release-gate 20260926-01 判断层 coverage 闭环批（S450-S453）：P0-3/P1-4~P1-6 零覆盖补场景，对齐 S330/S341/S342/S445 先例 ───
